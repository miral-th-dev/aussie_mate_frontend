        ...
        <div className="space-y-3">
          {jobs.map((job) => (
            ...
            >
              ...
              {/* Collapsible Details for Customer Card */}
                ...
                <div className="mt-4 pt-3 border-t border-gray-100 space-y-4">
                  ...
                  {(job.originalJob?.petType || job.originalJob?.numberOfPets || (job.originalJob?.petNeeds && job.originalJob.petNeeds.length > 0)) && (
                    <div className="space-y-3 pt-1">
                      {(job.originalJob.petType || job.originalJob.numberOfPets) && (
                        <div className="flex flex-wrap gap-2">
                      ...
                      {job.originalJob.petNeeds && job.originalJob.petNeeds.length > 0 && (
                        <div className="space-y-1.5">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {job.originalJob.petNeeds.map((item, idx) => (
                    ...
                    <div className="space-y-3 pt-1">
                      ...
                      {job.originalJob.handymanRequirements && job.originalJob.handymanRequirements.length > 0 && (
                        <div className="space-y-1.5">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {job.originalJob.handymanRequirements.map((item, idx) => (
                              <span key={idx} className="inline-flex items-center gap-1.5 bg-blue-50 border border-blue-100 px-3 py-1.5 rounded-full text-xs font-semibold text-blue-700">
                                📋 {item}
                              </span>
                            ))}
